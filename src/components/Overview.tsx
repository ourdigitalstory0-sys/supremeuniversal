                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                        ...
                        >
                            <div className="aspect-[4/5] overflow-hidden rounded-t-[140px] rounded-b-none relative z-10 shadow-2xl">
                                <img
                                    ...
                                    alt="Supreme Rivana Punawale 15-acre luxury riverside township exterior view with 31-storey towers near Hinjewadi IT Park Pune"
                    ...
                    <div className="lg:w-7/12 flex flex-col justify-center lg:pl-10">
                        ...
                        >
                            ...
                            >
                                Supreme Rivana is not just a residential development; it's a <strong>15-acre riverside township</strong> designed to dominate the <strong>Pune Real Estate Market</strong>. Featuring majestic <strong>31-storey towers</strong>, it represents the pinnacle of <strong>Supreme Universal Pune projects</strong>, offering a <strong>luxury lifestyle in West Pune</strong>. As a pioneer in <strong>luxury apartments Pune</strong>, we offer an exclusive collection of <strong>premium apartments in Punawale pune</strong>. Whether you are searching for the best <strong>Supreme Rivana price</strong> or exploring high-ROI <strong>real estate investment west pune</strong>, our project is engineered to be the definitive benchmark for excellence.
                            </motion.p>
                            ...
                            <motion.p
                                ...
                                className="text-gray-600 mb-6 leading-loose text-base md:text-lg font-sans font-light max-w-2xl"
                            >
                                Here, the gentle flow of the river meets cutting-edge architecture in our exclusive <strong>nature facing apartments pune</strong>. Enjoy generous spaces, abundant natural light, and a community that shares your vision of grandeur in the finest <strong>river view luxury apartments pune</strong>. With a firmly committed <strong>Supreme Rivana possession date</strong>, you can secure your luxury future in the most sought-after <strong>apartments near Hinjewadi IT Park</strong>.
                            </motion.p>
                            ...
                            >
                                As a fully <strong>MahaRERA-compliant</strong> development with <strong>IGBC Green Building Certification</strong>, Supreme Rivana represents the gold standard in sustainable luxury. Pre-approved by <strong>HDFC, SBI, ICICI, and Axis Bank</strong>, this is the most trusted <strong>new project in Punawale 2026</strong> for families, IT professionals, and <strong>NRI investors</strong> alike.
                            </motion.p>
